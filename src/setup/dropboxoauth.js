...
let initDropbox = () => {
	...
	// Check if token exists -> if not its the first run oder someone edited the config...
	if (config.get("dropbox.oAuthToken") === undefined || config.get("dropbox.oAuthToken") === "") {
